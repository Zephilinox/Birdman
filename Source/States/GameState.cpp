...
void GameState::dialogue_kitchen()
{
	...
	dialogue_tree.addDialogue("kitchen/comedy/start40", "terri", "You've had more than a few.", "kitchen/sad/start41");
	...
	dialogue_tree.addDialogue("kitchen/dark/start35", "nick", "Been what? , I'll tell you what real love is\n This happened a few months ago.", "kitchen/dark/start36");
	dialogue_tree.addDialogue("kitchen/dark/start36", "nick", "And it ought to make us ashamed when we talk\n like we know what we're talking about when we talk about love.", "kitchen/dark/start37");
	dialogue_tree.addDialogue("kitchen/dark/start37", "laura", "Nick, for God's sake. Are you getting drunk?", "kitchen/dark/start38");
	dialogue_tree.addDialogue("kitchen/dark/start38", "nick", "I don't have to be drunk to say what I think.", "kitchen/dark/start39");
	dialogue_tree.addDialogue("kitchen/dark/start39", "mel", "Nobody's drunk. We're just having a few drinks", "kitchen/dark/start40");
	dialogue_tree.addDialogue("kitchen/dark/start40", "terri", "You've had more than a few.", "kitchen/dark/start41");
	dialogue_tree.addDialogue("kitchen/dark/start41", "nick", "What are you, counting?", "kitchen/dark/start42");
	dialogue_tree.addDialogue("kitchen/dark/start42", "laura", "Don't talk like a drunk if you not...\"", "");
	...
	dialogue_tree.addDialogue("apartment/start18", "mike", "Put down the gun, Ed.\nShe just doesn't love you anymore\nYou need to move on.\"", "kitchen/start0");
}