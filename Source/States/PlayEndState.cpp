...
void PlayEndState::render() const
{
	...
	game_data->getRenderer()->renderSprite(*score_panel, Z_ORDER_LAYER::PANELS_HIGHER + 1);
	...
	game_data->getRenderer()->renderText(output_score, (game_data->getWindowWidth() / 2) - 80, (game_data->getWindowHeight() / 2) -40, 1.0f, c, Z_ORDER_LAYER::PANELS_HIGHER_TEXT);
}
